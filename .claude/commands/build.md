...
#### 3. Framework (si applicable)
```
Question: "Quel framework ?" (adapté au langage choisi)

Go: "Gin", "Echo", "Fiber", "Standard library"
Python: "FastAPI", "Django", "Flask", "None"
Node.js: "Express", "Fastify", "NestJS", "Next.js", "None"
...
#### 4. Base de données (si webapp/api/fullstack)
```
...
#### 5. Tests
```
Question: "Configuration des tests ?"
Options:
...
See: `.devcontainer/features/languages/<lang>/RULES.md`
...
3. **Créer les fichiers de base** selon le langage
   ...
   - Node.js: `package.json`, `tsconfig.json`, `src/index.ts`
   - Rust: `Cargo.toml`, `src/main.rs` ou `src/lib.rs`
   - Java: `pom.xml` ou `build.gradle`, structure Maven/Gradle
   - PHP: `composer.json`, `index.php`
   - Ruby: `Gemfile`, `lib/`

4. **Créer `.github/workflows/ci.yml`** si GitHub Actions choisi
